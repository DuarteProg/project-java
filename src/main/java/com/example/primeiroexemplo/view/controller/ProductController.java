...
import com.example.primeiroexemplo.view.model.ProductRequest;
import com.example.primeiroexemplo.view.model.ProductResponse;
...
public class ProductController {
    ...
    public ResponseEntity<Optional<ProductResponse>> getById(@PathVariable Integer id) {
        ...
        ModelMapper mapper = new ModelMapper();
        ProductResponse product = mapper.map(dto.get(), ProductResponse.class);
    ...
    public ResponseEntity<ProductResponse> addProduct(@RequestBody ProductRequest productReq) {
        ...
        return new ResponseEntity<ProductResponse>(mapper.map(productDto, ProductResponse.class), HttpStatus.CREATED);
    }
